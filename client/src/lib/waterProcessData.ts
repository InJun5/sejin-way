...
export const waterProcesses: WaterProcess[] = [
  {
    ...
    measurementPoints: [
      { id: "up-1", label: "원수 수질", x: 11, y: 50, parameters: ["pH", "탁도", "전도도", "TOC"], techId: "ph-conductivity" },
      { id: "up-2", label: "전처리 후", x: 25, y: 30, parameters: ["탁도", "SDI", "잔류염소"], techId: "turbidity" },
      { id: "up-3", label: "RO 투과수", x: 39, y: 30, parameters: ["전도도", "TOC", "pH"], techId: "toc" },
      { id: "up-4", label: "EDI 출구", x: 53, y: 30, parameters: ["비저항", "TOC", "DO"], techId: "resistivity" },
      { id: "up-5", label: "폴리싱 후", x: 67, y: 30, parameters: ["비저항", "TOC", "입자수"], techId: "resistivity" },
      { id: "up-6", label: "사용점", x: 82, y: 30, parameters: ["비저항", "TOC", "DO", "입자수"], techId: "toc" },
    ],
  },
  {
    id: "pure",
    ...
    measurementPoints: [
      { id: "pw-1", label: "원수 모니터링", x: 11, y: 50, parameters: ["pH", "탁도", "경도", "전도도"], techId: "ph-conductivity" },
      { id: "pw-2", label: "여과 후", x: 25, y: 30, parameters: ["탁도", "SDI"], techId: "turbidity" },
      { id: "pw-3", label: "연수화 후", x: 39, y: 30, parameters: ["경도", "전도도"], techId: "ph-conductivity" },
      { id: "pw-4", label: "RO 투과수", x: 53, y: 30, parameters: ["전도도", "TOC", "pH"], techId: "toc" },
      { id: "pw-5", label: "이온교환 후", x: 67, y: 30, parameters: ["전도도", "비저항", "실리카"], techId: "resistivity" },
      { id: "pw-6", label: "배수 품질", x: 82, y: 30, parameters: ["전도도", "pH", "TOC"], techId: "ph-conductivity" },
    ],
  },
  {
    id: "wastewater",
    ...
    measurementPoints: [
      { id: "ww-1", label: "유입 모니터링", x: 11, y: 50, parameters: ["pH", "COD", "SS", "중금속"], techId: "cod-bod" },
      { id: "ww-2", label: "균등조", x: 25, y: 30, parameters: ["pH", "ORP", "전도도"], techId: "ph-conductivity" },
      { id: "ww-3", label: "물리화학 후", x: 39, y: 30, parameters: ["탁도", "SS", "pH"], techId: "turbidity" },
      { id: "ww-4", label: "생물처리 중", x: 53, y: 30, parameters: ["DO", "NH4-N", "NO3-N", "pH"], techId: "do-nutrients" },
      { id: "ww-5", label: "2차 침전 후", x: 67, y: 30, parameters: ["SS", "탁도", "BOD"], techId: "turbidity" },
      { id: "ww-6", label: "방류 전 최종", x: 82, y: 30, parameters: ["COD", "BOD", "SS", "pH", "TN", "TP"], techId: "cod-bod" },
    ],
  },
  {
    id: "sewage",
    ...
    measurementPoints: [
      { id: "sw-1", label: "원하수 유입", x: 11, y: 50, parameters: ["유량", "COD", "SS", "pH"], techId: "cod-bod" },
      { id: "sw-2", label: "1차 침전 전", x: 25, y: 30, parameters: ["SS", "탁도"], techId: "turbidity" },
      { id: "sw-3", label: "폭기조 내", x: 39, y: 30, parameters: ["DO", "NH4-N", "pH", "MLSS"], techId: "do-nutrients" },
      { id: "sw-4", label: "2차 침전 후", x: 53, y: 30, parameters: ["SS", "탁도", "BOD"], techId: "turbidity" },
      { id: "sw-5", label: "소독 전후", x: 67, y: 30, parameters: ["잔류염소", "대장균", "탁도"], techId: "chlorine" },
      { id: "sw-6", label: "방류 최종", x: 82, y: 30, parameters: ["BOD", "COD", "SS", "TN", "TP", "pH"], techId: "cod-bod" },
    ],
  },
  {
    id: "reuse",
    ...
    measurementPoints: [
      { id: "ru-1", label: "유입 처리수", x: 11, y: 50, parameters: ["탁도", "COD", "SS", "병원성 지표"], techId: "turbidity" },
      { id: "ru-2", label: "MF/UF 투과수", x: 25, y: 30, parameters: ["탁도", "입자수", "SDI"], techId: "turbidity" },
      { id: "ru-3", label: "RO 투과수", x: 39, y: 30, parameters: ["전도도", "TOC", "pH"], techId: "toc" },
      { id: "ru-4", label: "고도산화 후", x: 53, y: 30, parameters: ["TOC", "오존", "UV투과율"], techId: "toc" },
      { id: "ru-5", label: "소독 후", x: 67, y: 30, parameters: ["잔류염소", "탁도", "pH"], techId: "chlorine" },
      { id: "ru-6", label: "재이용 수질", x: 82, y: 30, parameters: ["pH", "탁도", "전도도", "잔류염소"], techId: "ph-conductivity" },
    ],
  },
];
